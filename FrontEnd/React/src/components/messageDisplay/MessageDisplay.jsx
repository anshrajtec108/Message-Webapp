    ...
    return(
        <div className="message sent">
            ...
            <span className="metadata">
                <span className="time"></span><span className="tick"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" id="msg-dblcheck-ack" x="2063" y="2076">
                                ...
                                <div className="chat-container">
                                    ...
                                    <div className="conversation">
                                        ...
                                        <form className="conversation-compose">
                                            ...
                                            <input className="input-msg" name="input" placeholder="Type a mes.." autocomplete="off" autofocus />
                                            <div className="photo">
